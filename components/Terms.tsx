      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-gray-400 space-y-6 leading-relaxed">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>Возраст от 21 года (для некоторых моделей от 23 или 25 лет).</li>
            <li>Водительский стаж от 2-х лет.</li>
            <li>Наличие действительного водительского удостоверения категории «B» и паспорта.</li>
          </ul>

          <h3 className="text-xl text-white font-bold mt-6 mb-3">Оплата и залог</h3>
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>При аренде вносится страховой депозит, который возвращается при возврате автомобиля без повреждений.</li>
          </ul>

          <h3 className="text-xl text-white font-bold mt-6 mb-3">Использование автомобиля</h3>
          <ul className="list-disc pl-5 space-y-2">
            <li>Суточный лимит пробега — 250 км (превышение оплачивается отдельно).</li>
          ...
          <p>
            Все автомобили застрахованы по системе КАСКО (с ответственностью арендатора в пределах залога) и ОСАГО.
          </p>
        </div>
      </div>
    </section>
