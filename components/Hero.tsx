...
const heroBg = "https://images.unsplash.com/photo-1617788138017-80ad40651399?q=80&w=2940&auto=format&fit=crop";
...
export const Hero: React.FC = () => {
  return (
    <div className="relative h-screen min-h-[700px] w-full overflow-hidden flex items-center">
      ...
      <div className="relative z-10 max-w-[1920px] mx-auto px-6 lg:px-12 w-full pt-20">
        <div className="max-w-3xl">
          ...
          <h1 className="font-serif text-6xl md:text-8xl lg:text-9xl text-white mb-8 leading-[0.9] tracking-tight animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            Beyond <br />
            <span className="text-gray-500 font-light italic">Luxury.</span>
          </h1>
          
          <p className="text-gray-300 text-sm md:text-lg mb-12 max-w-md font-light leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-6 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
            <Link 
              to="/fleet"
              className="group relative px-10 py-5 bg-white text-black font-bold text-xs uppercase tracking-widest overflow-hidden transition-all hover:bg-gold-400"
            >
            ...
            <a 
              ...
              target="_blank"
              rel="noreferrer"
              className="group px-10 py-5 border border-white/20 text-white font-bold text-xs uppercase tracking-widest hover:border-white hover:bg-white/5 transition-all text-center flex items-center justify-center gap-2"
            >
              <span>Связаться</span>
      ...
      <div className="absolute bottom-0 right-0 z-20 hidden md:flex flex-col items-center gap-6 pb-12 pr-12 animate-fade-in-up" style={{ animationDelay: '1s' }}>
        ...
        <div className="w-px h-24 bg-gradient-to-b from-gray-500 to-transparent"></div>
      </div>
    </div>
  );
};
